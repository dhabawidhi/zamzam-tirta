...
<html lang="en" class="no-js">
    ...
    <body id="body">
        ...
        <section id="denah" class="service">
        <br> <br>
        <div class="container">
        	<div clas="row">
        		...
        		<div class="col-md-12">
        			<div class="text-center">
        				<img src="images/denah.png" width=80% />
        			</div>
        		</div>
        	</div>
        </div>
	...
	<section id="paket" class="service">
				<div class="container">
				  ...
				  <tbody>
					...
					<div class="panel panel-primary">
						  <div class="panel-heading">
						    <h3 class="panel-title">Harga dan Promo</h3>
						  </div>
						  <div class="panel-body">
						<h4><strong>Senin-Jumat</strong></h4>
						<h3>Rp. 20.000</h3>
						<br>
						<h4><strong>Sabtu,minggu, dan Tanggal merah </strong></h4>
						<h3>Rp. 35.000</h3>
						<br>
						<br>
						<br>
						<h4><strong>Anda Rombongan? beli tiket disini dan dapatkan penawaran khususnya</strong>	
						<a class="btn btn-primary" href="tiketkolam.php">klik</a></h4>
