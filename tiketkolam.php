...
<div class="container">
	<div class="row">
		<form action="ver_addtiket.php" method="post" enctype="multipart/form-data" name="form1" target="_self" class="form-horizontal" role="form">
		<div class="col-md-6 col-sm-6 ">
			...
			<div class="form-group">
				<label class="control-label" for="inputSmall">Banyaknya Orang</label>
				<input class="form-control input-sm" type="text" id="inputSmall" name="banyak">
			</div>
